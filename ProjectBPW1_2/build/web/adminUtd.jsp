                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="adminEdit.jsp?email=<%= list.get(i).getEmail()%>" class="btn btn-primary btn-sm text-white">edit</a> 
                            <a onclick="return confirm('are your sure ?')" href="userController?aksi=hapus&halaman=adminUtd.jsp&email=<%= list.get(i).getEmail()%>" class="btn btn-danger btn-sm text-white">hapus</a> </td>
                    </tr>
                </tbody>
                <% }%>
            </table>
